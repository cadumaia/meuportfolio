...
const ModalLinguagem = ({ linguagem, fecharModal }) => {
  const { titulo, conteudo, features, link } = linguagem;

  return (
    
    <div className="modal fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center animate-fadeIn z-50">
